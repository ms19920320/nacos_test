...
public class PlusCodeGenerator {
    ...
    public static void main(String[] args) {
        //====================配置变量区域=====================//
        String author = "ms";//生成文件的作者，可以不填

        // 生成的entity、controller、service等包所在的公共上一级包路径全限定名
        String rootPackage = "com.citycloud.nacostest.score";
        String moduleName = "score";

        // 数据库配置
        String url = "jdbc:mysql://120.46.181.75:3306/test?useSSL=false&characterEncoding=utf8";
